    ...
    return (
        <>
            <Modal show={show} onHide={handleClose} fullscreen>
                <Modal.Header className='d-flex justify-content-center text-center'closeButton >
                    <Modal.Title className='text-center d-flex justify-content-center' style={{marginLeft: "200px"}}>Set Up & Instructions <span style={{marginLeft: "3px"}}>(This screen can be accessed anytime in between questions)</span></Modal.Title>
                </Modal.Header>
                <Modal.Body className='w-75'>
                    ...
                    { 
                        ...
                        <>
                            ...
                            <p>Responses will be checked at the half-way point and when the timer reaches zero, or the host can check for responses by </p> */}
                            <p>Click the Check Responses button on the gameplay screen to see if everyone has responded</p>
                            ...
                            <p><strong>Once you click Start, this window will close and the first question will be displayed for the first question</strong></p>
                        </>
                        :
                        null
                    }
                    <h2 style={{color: '#A32CC4'}}>Gameplay</h2>
                    ...
                    <p><strong>By participating in this game, you agree to any charges incurred from your mobile provider or data used to play this game</strong></p>
                        <ul style={{fontSize: '20px'}}>
                            ...
                            <li>Gameplay consists of 5 questions and a final round!</li>
                            ...
                            <li>Players text their response to <strong>+1 (844) 238-4011</strong> (enter or save this number to your phone now!)</li>
